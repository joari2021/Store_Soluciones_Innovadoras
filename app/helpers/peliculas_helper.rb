module PeliculasHelper
  def link_to_add_rankings(name, pf, association)
    ...
    link_to(name, "#", class: "add_fields_rankings badge bg-info", data: { id: id, fields: fields.gsub("\n", "") })
  end
  ...
  def link_to_add_video_details(name, vd, association)
    ...
    link_to(name, "#", class: "add_fields_video_details badge bg-info", data: { id: id, fields: fields.gsub("\n", "") })
  end
end
